...
Public Sub Test_CheckBaseDuckDb()
    ...
    db.OpenDuckDb ThisWorkbook.Path & "\DbDuckDb.duckdb"   ' adapte si besoin
...
Sub Test_TableExists()
    ...
    Dim db As New cDuck
    db.Init ThisWorkbook.Path
    db.OpenDuckDb ThisWorkbook.Path & "\DbDuckDb.duckdb"   ' adapte le chemin
...
Public Sub Demo_PRAGMA_CheatSheet()
    ...
    db.Init ThisWorkbook.Path
    db.OpenDuckDb ThisWorkbook.Path & "\DbDuckDb.duckdb"   'ou ":memory:"
...
Public Sub Demo_ParquetInfo()
    ...
    parquetPath = ThisWorkbook.Path & "\TestParquetSearch.parquet"
