...
Public Sub TestAccessToDuckDb_AppendAdoRecordsetFast()
    ...
    rs.CursorLocation = 2
    rs.Open "SELECT * FROM [Clients]", cn, 0, 1, 1
...
Public Sub TestAccessToDuckDb_AppendAdoRecordset()
    ...
    rs.Open "SELECT * FROM [Clients]", cn, 0, 1, 1 'adOpenForwardOnly = 0, adLockReadOnly = 1, adCmdText = 1
